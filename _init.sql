...
EXECUTE IMMEDIATE $$
DECLARE
    wh_name VARCHAR := $wh_var;
BEGIN
    EXECUTE IMMEDIATE 'CREATE WAREHOUSE ' || wh_name || ' WITH WAREHOUSE_SIZE = XSMALL GENERATION = ''2'' AUTO_RESUME = TRUE AUTO_SUSPEND = 120 ENABLE_QUERY_ACCELERATION = TRUE QUERY_ACCELERATION_MAX_SCALE_FACTOR = 2';
END;
$$;
EXECUTE IMMEDIATE $$
DECLARE
